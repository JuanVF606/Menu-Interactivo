...
M2 = 'Por favor dijite una opcion:'

#                           DEFINICIONES
#Configuracion del buscaminas
from random import randint

#Configuracion Juego Buscaminas:
...
#Opciones:
def opciones():
    _print = int(input('(1) Tablero Personalizado (2) Tablero Automatico (3) Salir: '))
    if _print == 1:
        print('Proximamente')
    if _print == 2:
        Dificultades()
    if _print == 3 or _print != 3:
        exit
